...
export const ENEMIES = {
  asteroid_small: {
    ...
    speed: [70, 120], vrot: [-1.5, 1.5], contactDamage: 45, score: 10, gold: 1,
    ai: 'drift', color: 'enemy', render: 'asteroid', glow: 0, split: null,
  },
  asteroid_medium: {
    id: 'asteroid_medium', name: 'Asteroid', tier: 1, hp: 44, radius: 26,
    speed: [40, 85], vrot: [-0.9, 0.9], contactDamage: 65, score: 25, gold: 2,
  ...
  asteroid_large: {
    ...
    speed: [22, 55], vrot: [-0.5, 0.5], contactDamage: 100, score: 60, gold: 4,
    ai: 'drift', color: 'enemy', render: 'asteroid', glow: 0,
  ...
  boss_mothership: {
    ...
    speed: [20, 28], vrot: [0, 0], contactDamage: 110, score: 2500, gold: 350,
  ...
  boss_singularity: {
    ...
    speed: [24, 32], vrot: [0, 0], contactDamage: 120, score: 4000, gold: 600,
